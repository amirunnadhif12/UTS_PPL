    ...
    'ramadhan-syukur-sabar' => [
        ...
        'content' => '
            ...
            <ul class="list-none space-y-3 mb-6">
                ...
                <li class="pl-6 relative before:content-[\'✦\'] before:absolute before:left-0 before:text-secondary before:font-bold text-gray-600"><strong class="text-primary-dark">Baju Koko Slim Fit</strong> — material katun pilihan yang menyerap keringat, nyaman sepanjang hari.</li>
            ...
            <div class="bg-cream p-6 rounded-2xl mt-8">
                <h4 class="font-bold text-primary-dark mb-3\">Info & Pemesanan:</h4>
                <div class="grid md:grid-cols-2 gap-2 text-sm text-gray-600\">
                    <p>🛍️ Marketplace: Shopee, Tokopedia, TikTok Shop</p>
                    <p>📱 Instagram: <a href=\"https://www.instagram.com/as_sabar.id\" target=\"_blank\" class=\"text-primary hover:text-secondary\">@as_sabar.id</a></p>
                    <p>📘 Facebook: <a href=\"https://www.facebook.com/profile.php?id=61575614984498\" target=\"_blank\" class=\"text-primary hover:text-secondary\">As-Sabar Fashion</a></p>
                    <p>☎️ WhatsApp: <a href=\"https://wa.me/6285748169363\" target=\"_blank\" class=\"text-primary hover:text-secondary\">+62 857-4816-9363</a></p>
                </div>
            </div>
        '
    ]
